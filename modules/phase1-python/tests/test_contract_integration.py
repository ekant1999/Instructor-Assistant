...
from ia_phase1.equations import extract_and_store_paper_equations
...
def test_end_to_end_phase1_contract(
    ...
    monkeypatch.setenv("EQUATION_EXTRACTION_ENABLED", "false")
    ...
    equation_report = extract_and_store_paper_equations(sample_pdf, paper_id=901, blocks=blocks)
    ...
    assert equation_report["num_equations"] == 0
